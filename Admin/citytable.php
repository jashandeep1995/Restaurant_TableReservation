	...
	width:50px;
     ...
     while($x1=mysql_fetch_array($x))
	 {
		...
		$cat=mysql_fetch_array(mysql_query("select * from tb_country where s_no='$x1[country_id]'"));
		 $cat1=mysql_fetch_array(mysql_query("select * from tb_state where s_no='$x1[state_id]'"));
   ?>
							<tr>
								<td><?php echo $xy;?></td>
								<td class="center"><?php echo $cat['Country']; ?></td>
								<td class="center"><?php echo $cat1['state']; ?></td>
                               <td class="center"><?php echo $x1['city']; ?></td>
                                ...
                                <td class="center">
									<a class="btn btn-info" href="index.php?k1=city&k3=<?php echo $x1['s_no'];?>">
										<i class="icon-edit icon-white"></i>  
									</a>
									<a class="btn btn-danger" href="deletecat.php?k2=<?php echo $x1['s_no']; ?>&h1=<?php echo "city";?>">
