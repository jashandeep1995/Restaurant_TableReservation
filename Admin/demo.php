						...
						<form class="form-horizontal" action="<?php if($k3){ echo 'updatecat.php';}else{echo 'insertcat.php';}?>"  method="post" enctype="multipart/form-data">
						  <fieldset>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" rows="3" name="detail" required="required"><?php echo $cat['Detail']; ?></textarea>
							  </div>
							</div>
							<div class="form-actions">
							  <button type="submit" class="btn btn-primary" align="center">Submit</button>
							  <button type="reset" class="btn" align="center">Cancel</button>
							</div>
						  </fieldset>
						</form>   
