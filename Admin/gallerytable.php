...
session_start();
$x=mysql_query("select * from tb_gallery");
?>
<body>
<style type="text/css">
.a
{
            ...
            <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="icon-user"></i><span class="break"></span>Gallery</h2>
						<div class="box-icon">
   ...
   ?>
							<tr>
								<td><?php echo $xy;?></td>
								<td class="center"><?php echo $x1['gallery_name']; ?></td>
                                ...
                                <td class="center">
									<a class="btn btn-info" href="index.php?k1=gallery&k2=<?php echo $x1['s_no'];?>">
										<i class="icon-edit icon-white"></i>  
									</a>
									<a class="btn btn-danger" href="deletecat.php?k2=<?php echo $x1['s_no']; ?>&h1=<?php echo "gallery";?>">
