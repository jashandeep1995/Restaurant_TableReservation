...
if($k3)
{
	...
	$sub1=mysql_fetch_array(mysql_query("select * from tb_city where s_no='$k3'"));
...
.a
{
	...
	width:50px;
            ...
            <div class="row-fluid sortable">
						...
						<form class="form-horizontal"  action="<?php if($k3){ echo 'updatecat.php';}else{echo 'insertcat.php';}?>" method="post" enctype="multipart/form-data">
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
                               <select name="s1" onChange="cats(this.value,'ajx_state','display_state')" required="required">
             ...
             <div class="control-group" id="display_state">
							  <label class="control-label" for="typeahead">State </label>
							  <div class="controls">
                               <select name="s2" required="required">
...
<div class="controls">                     
<input type="text" name="sub" value="<?php echo $sub1['city']; ?>" required="required"/></div></div>
                                ...
                                <input type="hidden" name="h1" value="city" />
