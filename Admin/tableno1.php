...
session_start();
$x=mysql_query("select * from tb_tableno");
?>
   ...
   ?>
							<tr>
                                ...
                                <td class="center">
									<a class="btn btn-info" href="index.php?k1=tableno&k2=<?php echo $x1['s_no'];?>">
										<i class="icon-edit icon-white"></i>  
									</a>
									<a class="btn btn-danger" href="deletecat.php?k2=<?php echo $x1['s_no']; ?>&h1=<?php echo "tableno";?>">
