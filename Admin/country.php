...
if($k3)
{
	$cat=mysql_fetch_array(mysql_query("select * from tb_country where s_no='$k3'"));
						...
						<form class="form-horizontal" action="<?php if($k3){ echo 'updatecat.php';}else{echo 'insertcat.php';}?>" method="post">
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" name="country" value="<?php echo $cat['Country']; ?>" required="required">
                                <input type="hidden" name="h" value="<?php echo $k3;?>" />
                                <input type="hidden" name="h1" value="country" />
