...
<!-- Mirrored from lambert.kwst.net/site/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Oct 2015 04:11:35 GMT -->
<head>
                        ...
                        <div class="nav-holder">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="blog.php" class="act-link">Journal</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8 display-posts">
                                        <!--================= post ================-->
                                        <article class="post">
                                            <h4><a href="blog-single.php" class="ajax transition2">A Classic and Effective Blog Design</a></h4>
                                            <ul class="post-meta">
                                                <li>02 Frb</li>
                                                <li>22 com</li>
                                            ...
                                            <div class="post-media">
                                                <div class="single-slider-holder">
                                                    ...
                                                    <div   class="single-slider owl-carousel">
                                                        ...
                                                        <div class="item">
                                                            <img src="images/gallery/1.jpg" alt="" class="respimg">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-text">
                                            <div class="col-md-12">
                                                <div id="comments">
                                                    <!--title-->
                                                    <h6 id="comments-title">Comments <span>( 22 )</span></h6>
